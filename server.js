...
<head>
  ...
  <meta charset="utf-8">
  <meta name="H.SAIJEEVAN" content="width=device-width, initial-scale=1">
    ...
    <div class="row content">
      <div class="col-sm-4 sidenav">
        <div class="thumbnail">
          ...
          <img src="https://instagram.fbom4-1.fna.fbcdn.net/t51.2885-19/s150x150/19986035_479178559095616_954452302809268224_a.jpg" alt="Lights" style="width:100%" />
        </div>
        <h2 align="center"><b>H.SAI JEEVAN</b></h2>
        <p align="center">NOTHING,<br>HASURA,<br>VISHAKPATNAM.</p>
      </div>

      <div class="col-sm-8 text-left">
        <h3>I AM INTRESTED IN ACTING</h3>
        <p>UPCOMMING ACTOR.</p>
        <hr>
        <h3>Education</h3>
        <p> STILL STUDING 9</p>
        ...
        <p>WENT TO DAY AT SEA LAST SUNDAY<p>
        <hr>
